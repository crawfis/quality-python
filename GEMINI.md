# AI Bootcamp - Quality Project (Python)
...
Write clean, simple, professional Python code:
...
- pytest is always OK since we use TDD.

## Project Setup

- This is a Python project using pip and venv
...
- Over-abstraction (no ABC for something with only one implementation)
